    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="theme-setting-wrapper">
        ...
        <div id="theme-settings" class="settings-panel">
          ...
          <div class="sidebar-bg-options selected" id="sidebar-light-theme"><div class="dashboard/img-ss rounded-circle bg-light border mr-3"></div>Light</div>
          <div class="sidebar-bg-options" id="sidebar-dark-theme"><div class="dashboard/img-ss rounded-circle bg-dark border mr-3"></div>Dark</div>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="addproduct">Add New</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/dropdowns">Edit</a></li>
